    ...
    <Container>
      ...
      <div>
        <Text tag="p" clr="primary" sz="normal" className="container">
          ...
          один этаж стоит 200 рублей.У нас действуют специальные предложения,
          согласно которым, купленные кондиционеры в интернет-магазине «Лайт
          климат» доставляются и устанавливаются бесплатно.
        </Text>
      </div>
